...
public class SVGDefinition {
    ...
    private static String[] symbolAttributeTag = new String[] { "x",
            "y",
            "width",
            "height",
            "viewBox",
    ...
    private boolean documentAttribute(Property p) {
        ...
        for (int i = 0; i < SVGDefinition.symbolAttributeTag.length; i++) {
            if (SVGDefinition.symbolAttributeTag[i].equalsIgnoreCase(name)) {
                return false;
            }
        }
