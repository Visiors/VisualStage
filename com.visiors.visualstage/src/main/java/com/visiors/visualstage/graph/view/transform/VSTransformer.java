...
public class VSTransformer extends SimpleTransformer implements Transformer {
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#setTransform(com.visiors
	 * .visualstage.view.transform. DefaultTransformer)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#setTranslateX(double)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#setTranslateY(double)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#setRotation(double)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#transformToScreen(
	 * java.awt.Point)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#transformToGraph(java
	 * .awt.Point)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#transformToScreenX
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#transformToScreenY
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#transformToGraphX(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#transformToGraphY(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#addListener(com.visiors
	 ...
	 * 
	 * @see
	 * com.visiors.visualstage.view.transform.Transformer#removeListener(com
	 * .visiors.visualstage.view.transform. TransformValueChangeListener)
	 */
	@Override
